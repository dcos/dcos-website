...
- DCOS-16737 - You cannot generate and publish AWS Advanced Templates. When running the command `dcos_generate_config.sh --aws-cloudformation` with GovCloud credentials you will see an error similar to this:
