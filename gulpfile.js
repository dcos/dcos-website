...
const sharedSiteTasks = ['copy', 'browserify', 'styles', 'nginx-config', 's3-config']

gulp.task('build', ['build-site'])
gulp.task('build-site', ['build-site-templates', 'build-event-templates', 'build-blog-templates', ...sharedSiteTasks])
